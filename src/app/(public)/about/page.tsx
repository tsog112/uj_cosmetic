      ...
      <section className="py-20 md:py-28 border-thin-t px-6 lg:px-10" id="contact">
        <div className="max-w-[600px] mx-auto">
          ...
          {formSubmitted ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-6 rounded-2xl border border-border-faint bg-white p-5 shadow-brand-md sm:p-7">
              <div>
                ...
                <input
                  ...
                  name="name"
                  required
                  className="w-full rounded-xl border border-border-light bg-sand px-4 py-3 text-sm text-charcoal placeholder:text-text-faint transition-colors focus:border-dusty-rose focus:bg-white focus:outline-none"
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows={5}
                  className="w-full resize-none rounded-xl border border-border-light bg-sand px-4 py-3 text-sm text-charcoal placeholder:text-text-faint transition-colors focus:border-dusty-rose focus:bg-white focus:outline-none"
                  placeholder="Таны мессеж..."
                />
              </div>

              <button type="submit" className="flex min-h-14 w-full items-center justify-center rounded-full bg-dusty-rose px-6 text-sm font-semibold text-white shadow-brand-md transition-colors hover:bg-charcoal">
                Илгээх
              </button>
            </form>
          )}
